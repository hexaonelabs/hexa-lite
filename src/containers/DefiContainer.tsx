...
export const DefiContainer = ({
  ...
  return (<IonGrid class="ion-no-padding" style={{ marginBottom: "8rem" }}>
        ...
        <IonText color="medium">
          ...
          >
            <span style={{ maxWidth: "800px", display: "inline-block" }}>
              ...
              {poolGroups.length > 0 ? poolGroups.length : (<IonSkeletonText animated={true} style={{width: '20px', display: 'inline-block'}} />)}
              {" "}open markets accessible to all across{" "}
              {
                CHAIN_AVAILABLES.filter((chain) => chain.type === "evm")
                  .length
              }{" "}
              networks, borrow assets using your crypto as collateral and earn interest 
              without any restrictions or censorship by providing liquidity over a
            </span>
            <span
            ...
            >
              ${(totalTVL||0) > 0 
                ...
                : (<IonSkeletonText animated={true} style={{
                  width: '80px', 
    ...
    {(walletAddress && poolGroups && poolGroups.length > 0) && (<IonRow class="ion-justify-content-center ion-padding">
            ...
            <IonItem slot="header">
              <IonGrid class="ion-no-padding">
                <IonRow class="ion-text-center">
                  <IonCol size="12" size-md="4" class=" ion-padding-vertical">
                      ...
                      <IonText>
                        <p>
                          {!walletAddress
                            ...
                            : "Deposit"}{" "}
                          assets as collateral to start earning
                          interest and enable borrowing
                        </p>
                      </IonText>
                    </IonCol>
                  </IonRow>
