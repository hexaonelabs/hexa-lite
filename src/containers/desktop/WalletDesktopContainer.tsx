  ...
  render() {
    return (
      <>
        ...
        <IonGrid
          class="ion-padding"
          style={{ marginBottom: "5rem", maxWidth: "1224px", paddingTop: "3rem" }}
        >
          <IonRow
          ...
          >
            ...
            <IonCol size="6" class="ion-text-end">
              ...
              >
                <IonIcon color="primary" icon={paperPlane} slot="start" />
                <IonText color="primary">Send</IonText>
              </IonButton>
              <IonButton
                color="dark"
              ...
              >
                <IonIcon color="primary" icon={download} slot="start" />
                <IonText color="primary">Deposit</IonText>
              </IonButton>
            </IonCol>
          </IonRow>
          ...
          {this.state.assetGroup.length > 0 && (
            <IonRow class="widgetWrapper" style={{ marginTop: "3rem" }}>
